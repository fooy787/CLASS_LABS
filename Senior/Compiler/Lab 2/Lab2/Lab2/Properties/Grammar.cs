...
public class Grammar
{
    ...
    public Grammar(string specfile, bool caseInsensitive)
    {
        ...
        bool whiteSpaceInThere = false;
        foreach(var v in terminals)
        {
            if (v.rex.ToString().Equals("\\s+")) whiteSpaceInThere = true;
        }
        if(!whiteSpaceInThere) terminals.Add(new Terminal("WHITESPACE", new Regex("\\s+")));
    ...
    public List<Terminal> returnList()
    { return terminals; }
}
