...
public class tester {
    public static void main(String[] args) {
        ...
        LinkedList<String>.LinkedListIterator LI = L.iterator();//Creates new forward iterator
        //LinkedList<String>.LinkedListIterator LT = L.iterator();
        while (LI.hasNext())
        {
            String s = LI.next();
            System.out.println("\t" + s);//Prints each line
        }
       /* I couldnt get this to work
       LI.remove();//Removes one item from the LinkedList
        while (LT.hasNext()){
            String s = LT.next();
            System.out.println("\t"+ s);//Prints each line
        }*/
